...
## [Unreleased]
### Added
- Internal shared infrastructure for upcoming `infra install --template`/`server install --template` support (built-in "workspace" templates, template resolution, post-start-action dispatch) — no user-facing change yet.
