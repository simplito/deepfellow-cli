...
- **Format:** Markdown (`.md`)
- **Location:** `/tasks/`
- **Filename:** `[CURRENT-DATE]-[PRD-FILE-NAME]-TASKS.md` (e.g., `2025-05-28-PRD-USER-PROFILE-EDITING-TASKS.md`)
...
8.  **Save Task List:** Save the generated document in the `/tasks/` directory with the filename `[CURRENT-DATE]-[PRD-FILE-NAME]-TASKS.md`, where `[PRD-FILE-NAME]` matches the base name of the input PRD file (e.g., if the input was `2025-05-28-USER-PROFILE-EDITING-PRD.md`, the output is `2025-05-28-USER-PROFILE-EDITING-TASKS.md`).
