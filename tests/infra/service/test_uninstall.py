...
@mock.patch(
    "deepfellow.infra.service.uninstall.resolve_infra_connection", return_value=("http://infra:8086", "test-key")
)
...
@mock.patch("deepfellow.infra.utils.connection.persist_infra_connection")
@mock.patch("deepfellow.infra.service.uninstall.make_request")
@mock.patch("deepfellow.infra.service.uninstall.resolve_infra_connection", return_value=("http://bad:8086", "bad-key"))
def test_uninstall_does_not_persist_connection_when_request_fails(
    ...
    with pytest.raises(typer.Exit):
        uninstall(server="http://bad:8086", name="ollama", purge=False)
