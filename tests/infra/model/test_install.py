...
from deepfellow.infra.model.install import install
...
@mock.patch("deepfellow.infra.model.install.post")
@mock.patch("deepfellow.infra.model.install.read_env_file", return_value={"DF_INFRA_ADMIN_API_KEY": "test-key"})
