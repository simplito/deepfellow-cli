...
from deepfellow.server.toolbox.utils import create_toolbox
...
def create(
    ...
    toolbox = create_toolbox(server_url, token, project_id, organization_id, name)
